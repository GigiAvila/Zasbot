...
export const FOOTER_CONTACT_TITLE = 'Send us a message!'
export const FOOTER_CONTACT_TEXT =
  'Need support or want to know more about us? We are always just one email away.'
export const FOOTER_CONTACT_BUTTON_TEXT = 'Contact us'

export const FOOTER_TERMS_TEXT = 'Terms & Conditions'
